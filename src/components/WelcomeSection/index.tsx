...
const WelcomeSection = ({ imageSrc, title, description, secondDescription, secondImageSrc }: WelcomeSectionProps) => {
  ...
  return (
    ...
    <Box ref={sectionRef} height="250vh" position="relative">
      ...
      >
        ...
        {/* Second Background Image (fades in/out with second paragraph) */}
        {secondImageSrc && (
          <Box 
            position="absolute" top left right bottom zIndex={new FixedZIndex(1)}
            dangerouslySetInlineStyle={{
              __style: {
                opacity: Math.max(0, Math.min(1, secondParagraphOpacity)),
